...
with open(infile,"rt") as IN:
    ...
    for line in IN:
        ...
        (input1_alt,input1_ref)=(input1_ref,input1_alt)
        (input2_alt,input2_ref)=(input2_ref,input2_alt)
        (input3_alt,input3_ref)=(input3_ref,input3_alt)
        (output1_alt,output1_ref)=(output1_ref,output1_alt)
        (output2_alt,output2_ref)=(output2_ref,output2_alt)
        (output3_alt,output3_ref)=(output3_ref,output3_alt)
